...
public class AuditedFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		view = inflater.inflate(R.layout.onlineaudit_list,
				container, false);
		initView();
		//new GetAuditListDataTask().execute();
		...
		pullToRefreshListView
				.setOnRefreshListener(new PullToRefreshBase.OnRefreshListener<ListView>() {
					...
					public void onRefresh(
						...
						new GetAuditListDataTask().execute("1", "5", "10");
	...
	private class GetAuditListDataTask extends
		...
		protected void onPostExecute(List<AuditBean> list) {
			adapter = new AuditsListAdapter(AuditedFragment.this, list, null,
					getListView());
